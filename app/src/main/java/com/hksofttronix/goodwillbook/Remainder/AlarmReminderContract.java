...
public class AlarmReminderContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.hksofttronix.goodwillbook";

    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    public static final String PATH_VEHICLE = "reminder-path";
    public static final String PATH_VEHICLE_RefreshAll = "RefreshAll-path";
    ...
    public static final class AlarmReminderEntry implements BaseColumns {
        ...
        public static final Uri CONTENT_URI_RefreshAll = Uri.withAppendedPath(BASE_CONTENT_URI, PATH_VEHICLE_RefreshAll);
        ...
        public final static String TABLE_NAME = "remaindermaster";

        public final static String _ID = BaseColumns._ID;

        public static final String KEY_TITLE = "title";
        public static final String KEY_MOBNO = "mobilenumber";
